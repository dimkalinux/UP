...
$PHPTHUMB_CONFIG['error_image_width']           = 600;      // default width for error images
...
$PHPTHUMB_CONFIG['error_fontsize']              = 5;        // size of text in error messages, from 1 (smallest) to 5 (largest)
